var accordion=document.querySelectorAll(".accordion");if(window.innerWidth<600)for(var i=0;i<accordion.length;i++)accordion[i].addEventListener("click",function(){this.classList.toggle("active");var e=this.closest(".product-container").querySelector(".panel");e.style.maxHeight?e.style.maxHeight=null:e.style.maxHeight=e.scrollHeight+"px"});
